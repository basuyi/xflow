package net.ms.designer.editors.component.actions;

import java.util.List;

import net.ms.designer.editors.component.ComponentPlugin;
...
public class PropertyAction extends SelectionAction 
{
	...
	public PropertyAction(IWorkbenchPart part) 
	{
		...
		setText("Property");
		setId(PROPERTY);
		setImageDescriptor(ImageDescriptor.createFromFile(ComponentPlugin.class,"/icons/sample.gif")); //$NON-NLS-1$
	...
	private boolean canPerformAction() 
	{
		...
		for (int i=0; i<parts.size(); i++)
		{
			...
			if (!(part.getModel() instanceof Component))
			{
				return false;
			}
		}
